...
from hcad_star_schema.domain.real_estate.parcel.parcel_source import ParcelSource
from hcad_star_schema.domain.real_estate.parcel.parcel_source import TabSeparatedParcelSource
